...
import com.ahesan.ecommerce.auth_service.dto.ErrorDetail;
import com.ahesan.ecommerce.auth_service.enums.ErrorType;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleUserAlreadyExists(UserAlreadyExistsException ex) {
        ...
        log.warn("User already exists. Reason: {}", ex.getMessage());
    ...
    public ResponseEntity<ApiResponse<Object>> handleExternalService(ExternalServiceException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_GATEWAY)
                .body(ApiResponse.error(
                        ...
                        buildError(ErrorType.SYSTEM, "External service failure")
                ));
    }

    @ExceptionHandler(UnableToCreateAccountException.class)
    public ResponseEntity<ApiResponse<Object>> handleUnableToCreateAccount(UnableToCreateAccountException ex) {
